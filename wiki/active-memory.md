...
- [电力计划](./%E7%94%B5%E5%8A%9B%E8%AE%A1%E5%88%92.md) — 影子断电、板朝太阳、夜里吃电池、没电丢姿态。先有电这个量，再有太阳和影子，再进目录和库存船。人能看见的，MCP 也能看见。不要超级零件。不要改火箭物理。不要发明没飞过的遥测。
...
- [versioning](./modules/versioning.md) — 说明 Moonshot 的长期预发布版本：`0.<era>.<minor>.<build>`。默认只加 build。大版本和换代必须用户亲口说。
