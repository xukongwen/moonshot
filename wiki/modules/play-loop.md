...
- **例结点：** LKO、转移窗口、TDI/逃逸后、进 SOI、捕获、丢掉转移级、着陆、上升后。
...
A1–A6 已做。2026-08-16 agent 路径 Duna 着陆并回家已飞通，瑕疵照写，见 [../2026-08-16-agent-duna-往返.md](../2026-08-16-agent-duna-往返.md)。肌肉还粗。实现切片见 [游戏内Agent计划.md](../游戏内Agent计划.md)。
